...
import { designerApi, onNotification } from "../lib/ipc";
import {
...
export function ChatLayout() {
  ...
  React.useLayoutEffect(() => {
    if (pathname.startsWith("/design") && (environmentPanel.toolsOpen || environmentPanel.quickViewOpen)) {
      environmentPanel.closeAll();
    }
  }, [environmentPanel.closeAll, environmentPanel.toolsOpen, environmentPanel.quickViewOpen, pathname]);
