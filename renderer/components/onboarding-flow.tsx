...
const featureBentos: FeatureBento[] = [
  ...
  },
  {
    ...
    description:
      "Create reusable instructions, then type $ to attach one. Turn all skills off anytime in Settings → Skills.",
    icon: Wand2,
  ...
  },
  {
    ...
    description:
      "Browse plugins, connect hosted MCP servers, and expose only the tools you enable.",
    icon: Plug,
