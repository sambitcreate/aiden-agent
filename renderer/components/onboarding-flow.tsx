...
const featureBentos: FeatureBento[] = [
  {
    ...
    description: "Read, search, edit, and run commands in your workspace. Queue follow-ups, edit them, or steer the next response. Aiden follows your global and workspace AGENTS.md guidance, refreshing it between model turns.",
    icon: MessageSquare,
