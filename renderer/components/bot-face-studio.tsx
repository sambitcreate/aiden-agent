...
function AvatarOption({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`relative flex min-h-20 flex-col items-center justify-center gap-1 rounded-card px-1 py-2 outline-none transition-[background-color,border-color,box-shadow] duration-150 focus-visible:ring-2 focus-visible:ring-focus-ring disabled:cursor-default disabled:opacity-55 ${
        selected
