            ...
            return (
              <figure key={attachment.id} className="min-w-0">
                <button
                  ...
                  className={cn(
                    "group/image relative block max-w-full overflow-hidden rounded-xl border border-separator bg-control text-left outline-none transition-colors hover:border-tertiary focus-visible:ring-2 focus-visible:ring-focus-ring motion-reduce:transition-none",
