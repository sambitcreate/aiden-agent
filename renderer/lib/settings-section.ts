...
export const SETTINGS_DESTINATIONS: ReadonlyArray<{
  ...
  { id: "providers", title: "Providers", group: "Agent", keywords: ["models", "api", "keys"] },
  {
    ...
    title: "Model Pad",
    group: "Agent",
    keywords: ["personal", "models", "arrange", "rank", "capability", "speed", "pace", "artificial analysis"],
  },
  ...
  },
  {
    ...
    title: "Aiden",
    group: "Agent",
    keywords: ["assistant", "companion", "chat", "hotkey", "shortcut", "model", "access", "proactive"],
  },
  {
    id: "computerUse",
    title: "Computer Use",
  ...
  { id: "voice", title: "Voice", group: "App", keywords: ["microphone", "audio", "transcription", "dictation"] },
  { id: "shortcut", title: "Keyboard shortcuts", group: "App", keywords: ["hotkey", "command"] },
  { id: "appearance", title: "Appearance", group: "App", keywords: ["theme", "light", "dark"] },
  { id: "about", title: "About", group: "App", keywords: ["version", "build", "github", "repository", "app information"] },
];
