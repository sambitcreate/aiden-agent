...
- Build `11` adds the refreshed Pi-hosted model catalog and first-class iOS pairing choices for QR, nearby local setup, private Tailscale setup, and full-payload fallback. It is `VALID`, `IN_BETA_TESTING` for `Internal Testers`, and externally `NOT_APPLICABLE`.
- Build `12` introduced bidirectional chat images, durable terminal outcomes, adaptive onboarding, and the sender-anchored card deck. It processed as `VALID` but was superseded before tester assignment by the corner-mask correction in build `13`.
- Build `13` preserves all four continuous image corners across aspect ratios. It is `VALID`, `IN_BETA_TESTING` for `Internal Testers`, and externally `NOT_APPLICABLE`.
- Build `14` adds reliable mobile approval recovery, bounded mobile approval summaries, durable terminal reconciliation, and first-class Mac-to-mobile image sharing. It is `VALID` and was superseded by build `15` after the cross-platform activity presentation was normalized.
- Build `15` adds Mac-aligned typed activity timelines, concise expandable activity history, and Reduce Motion-aware shimmer/fade treatment. It is `VALID`, `IN_BETA_TESTING` for `Internal Testers`, and externally `NOT_APPLICABLE`.
- Build `17` introduced the Bots-first candidate with canonical provider/model authority, safe iOS Bot-editor recovery, and OAuth refresh/admission ordering.
- Build `21` makes Bot replies final-answer-first: intermediate narration and tool steps stay in the collapsed activity disclosure, stream projection resets replace stale progress, and only the terminal answer renders as the normal reply. It is `VALID`, `IN_BETA_TESTING` for `Internal Testers`, and externally `NOT_APPLICABLE`.
- Build `22` adds native-or-companion Bot image understanding, exact companion authority and cancellation fencing, cache-first fail-closed iOS image capability, and explicit second-provider setup/privacy affordances. Exact build `f31801d1-91c1-4c79-8086-24bfec4c8078` is `VALID`, `IN_BETA_TESTING` for `Internal Testers`, and externally `NOT_APPLICABLE`.
- Builds `18` and `19` established one persistent chat per Bot, cache-first mobile state, durable model authority, and the first desktop Bot editor/access bridge.
- Build `20` is the current Bots-first candidate. It contains the hardened one-chat runtime, contact-first Messages-inspired Bot flow, stable avatar caching, restored shared composer, rounded tail-free bubbles, immediate exact-cache chat hydration, and layout-shaped cold skeletons from source commit `78e6c77f9`. It is `VALID`, assigned to `Internal Testers`, reports `IN_BETA_TESTING`, and remains externally `NOT_APPLICABLE`.
- Current exact build resource ID: `f31801d1-91c1-4c79-8086-24bfec4c8078` (build `21`: `79c1ac3f-329e-4a4b-8585-0b156657fba1`; build `20`: `835fe999-4821-4755-8906-2d71c56a4f11`; build `19`: `e52c1988-56e6-4cea-8de3-ce27711ef970`; build `18`: `47ca3b75-24c4-4fa5-bb28-14767a04fbbe`; build `17`: `b5bf4299-7e86-4304-97e1-77e77af9b09c`; build `16`: `4389a0ee-430b-46e7-97ca-bea553b6f335`; build `15`: `0185ac70-617f-47d2-b959-d17f13e9a9d2`; build `14`: `e0a7152d-3ab7-41a3-89c0-e037fa9d8244`; build `13`: `c5988f33-3184-4e04-8205-9c4505cfc894`; build `12`: `588fef66-7ecc-4b6d-b04a-3539da52fad0`; build `11`: `7c372144-6f64-46cb-880f-2ad92043198d`; build `10`: `426041ab-8638-4b6a-9d10-59ab2ee5b79b`; build `9`: `7ed5d771-0ebe-4e38-b9e9-fab9c564794f`; build `8`: `b0d3c1c0-ab61-469f-9e4f-9dd250e1ff1a`; build `7`: `717b6381-4dec-4cce-85d1-72b503c28590`; build `6`: `aa994233-1bf3-4482-86f5-b8b0356eee25`; build `5`: `6173d5e2-0e58-4d0a-92fa-fc804fc82c37`; build `4`: `ee5b7c23-14d6-44e7-a4ba-6a5003018758`; build `3`: `e5f0ae7e-35aa-451e-be87-bc039885b2de`; build `2`: `721aeb9d-2b33-4729-8d10-5bc1783abbef`).
