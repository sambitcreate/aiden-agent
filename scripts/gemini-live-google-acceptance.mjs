...
try {
  ...
  console.error(
    "Usage: AIDEN_GEMINI_LIVE_REAL_ACCEPTANCE=1 npm run test:gemini-live:google:acceptance -- --i-understand-real-google-call --model gemini-3.8-live-extended-thinking",
  );
  process.exitCode = 2;
}
