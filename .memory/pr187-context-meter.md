...
- Ambient estimates skip MCP tools, MCP server instructions, AGENTS instructions and generation-scoped tools, so they read as "estimated" until the chat generates again.
