/*
Vendored copy of main/services/advisor-runtime.ts for the Aiden CLI. esbuild fails to
remap advisor-runtime.ts's sibling ".js" specifier to ".ts" inside the CLI
bundle graph (the identical remap works for other files in the same
directory), so this file is vendored with import specifiers rewritten to
explicit paths. tests/extensions.test.mjs enforces byte parity modulo those
...
} from "../../../../../renderer/shared/generation-thinking.ts";
import { parseAdvisorSelection, type AdvisorSelectionV1 } from "../../../../../renderer/shared/advisor.ts";
import { AdvisorAttemptStore, type AdvisorAttemptFailure } from "./advisor-attempt-store.ts";
import { boundedAdvisorText, projectAdvisorContext } from "./advisor-context.ts";
import { resolveGenerationThinkingLevel } from "../../../../../main/services/generation-runtime.ts";
import type { ResolvedModelRuntime } from "../../../../../main/services/model-runtime-core.ts";
import type { PiAgentRuntimeExtension } from "../../../../../main/services/pi-agent-runtime-harness.ts";
import { declarePiRuntimeReplay } from "../../../../../main/services/pi-runtime-tool.ts";
import { isNonChatModel } from "../../../../../renderer/shared/model-eligibility.ts";
import type { Provider } from "../../../../../main/services/types.ts";
