/*
Vendored copy of main/services/advisor-context.ts for the Aiden CLI. esbuild fails to
...
import { compactGenerationContext } from "../../../../../main/services/generation-context.ts";
