...
| [Compaction](compaction-plan.md)                                                                   | Partial | Pi-native semantic checkpoints and 2026-08-14 lifecycle hardening ship; durable memory, deeper summary validation, provider-native paths, and measured rollout tuning remain open. |
