...
| [Telegram Remote Control](telegram-remote-control-plan.md)                                       | Partial | Phases 0–5 ship: clean-slate port of pi-telegram (Bot API, polling, pairing, queue, Markdown→HTML delivery, headless turn shim, service lifecycle, Settings UI, IPC handlers, 50 tests). Phase 6 onboarding bento deferred pending the 1024×1024 PNG asset. |
