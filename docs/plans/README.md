...
| [Slash Commands and Skill Invocation](slash-commands-and-skill-invocation-plan.md)          | Active  | Phases 0–4 are complete: one-turn skills and the selected session-command set ship; final release hardening and packaged/performance gates are next.                       |
