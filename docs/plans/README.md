...
| ------------------------------------------------------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [GPUI UI Fidelity](gpui-ui-fidelity-plan.md)                                               | Active  | Core shell through Skills, shortcut truth, provider security, native Codex/Apple titles, and the full 2-D Model Picker are accepted; Appearance, MCP, dynamic Pi setup, and later settings remain in progress. |
