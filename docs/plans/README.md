...
| [Telegram Remote Control](completed/telegram-remote-control-plan.md)                             | Complete | Long-polling remote control ships with owner pairing, queueing, Markdown delivery, explicit optional folder-workspace authority, isolated backing chats, Settings UI, 59 focused tests, and onboarding coverage. |
