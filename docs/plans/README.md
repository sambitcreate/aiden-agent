...
| ------------------------------------------------------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [GPUI End-to-End Parity](gpui-parity-plan.md)                                              | Active  | Normal chat now has coding tools, Skills, web search, thinking, compaction, attachments, and one-shot approvals; Codex has a quit-safe offline GPUI auth host but no visible flow, and Computer Use has drop-safe controller/settings/status/host plus fresh-verified runtime foundations while GPUI/provider wiring, subagents, settings/workbench, scheduler, and broader app-lifetime parity remain open. |
| [GPUI + Rust Port](../gpui-port/PORT-PLAN.md)                                               | Partial | Crate-level porting and a bootable shell are substantial groundwork. The former completion claim is superseded by the end-to-end parity plan and workflow matrix.        |
