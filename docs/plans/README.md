...
| [Slash Commands and Skill Invocation](slash-commands-and-skill-invocation-plan.md)          | Active  | Phases 0–3 are complete: bounded one-turn skill invocation, safe provenance, and durable lifecycle/recovery now ship; selected session commands are next.                   |
