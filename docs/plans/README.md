...
| [Performance, Stability, Battery, and Efficiency](performance-stability-efficiency-plan.md)        | Active  | Phase 0 diagnostics, profiling package, fixtures, receipt verification, and build/package budgets are implemented; complete AC and portable-Mac battery baselines remain open. |
