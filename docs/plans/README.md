...
| [Slash Commands and Skill Invocation](completed/slash-commands-and-skill-invocation-plan.md)   | Complete | One canonical slash palette now dispatches app actions and fresh workspace-bound one-turn skills with safe provenance and release-validated UX.   |
