...
| [Slash Commands and Skill Invocation](slash-commands-and-skill-invocation-plan.md)          | Active  | Phases 0–1 are complete: contracts plus one bounded main-process skill registry now unify tools, prompt disclosure, safe catalog IPC, and resolution; composer palette is next. |
