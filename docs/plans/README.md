...
| [Slash Commands and Skill Invocation](slash-commands-and-skill-invocation-plan.md)          | Active  | Phase 0 contracts, bounds, opaque identity, deterministic collision policy, and parser/ranker foundations are complete; unified skill resolution is next.                    |
