...
| ------------------------------------------------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| [Aiden Assistant](aiden-assistant-plan.md)                                                  | Partial     | The dock, main-chat Markdown rendering, and confirmed global/project/MCP automation creation ship; settings tools and proactivity remain planned. |
