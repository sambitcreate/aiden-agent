...
| [Gemini Live Assistant](gemini-live-assistant-plan.md)                                             | Partial | Phases 0–4 implementation, double review, focused/full gates, and hardened development package pass; native screen-picker and real-Google operator receipts remain open. |
