...
| [Slash Commands and Skill Invocation](slash-commands-and-skill-invocation-plan.md)          | Active  | Phases 0–2 are complete: one bounded registry now powers the shipped composer Commands/Skills palette; active one-turn skill invocation is next.                          |
