...
- Local validation: 51 focused tests passed, including two-connection contention, corruption/write-failure preservation, control/Stop recovery, unknown parent/child effects, resumed-head mismatch and real SIGKILL/reopen. Type-check, lint, 16 CI registry/routing tests and diff whitespace validation passed.
