...
Local verification completed on 2026-09-25: 40 focused rich-link and transcript tests, 451 Bot tests, the Chat/slash-command suite, TypeScript, ESLint, CI policy, the production build, and `git diff --check` passed. Hands-on packaged-app and assistive-technology acceptance remains part of PR review.
